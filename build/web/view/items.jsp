      ...
      <a href="verkoop">Verkoop</a>
       ...
       <c:forEach items="${product}" var="product">
        <tr>
            ...
            <td><c:out value="${product.merk}" /></td>
             <td><c:out value="${product.qty}" /></td>
                  ...
                  <input type="submit" value="Product Registreren" class="btn  btn-info" data-toggle="modal" data-target="#productModal"/>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Product Registreren </h4>
      </div>
      <div class="modal-body">
        <form method="POST" action="${pageContext.request.contextPath}/InsertProduct">
            ...
            <div class="form-group">
                <label>Merk</label>
                <input type="text" name="merk" class="form-control" value="" required/>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <a data-dismiss="modal" class="btn btn-danger pull-right">Cancel</a>            </div>
      </form>
      </div>
    </div>
