...
.btn-info{
  ...
  <ul>
    ...
    <li>
     ...
     <li>
      <a href="verkoop" class="active">Verkoop</a>
    </li>
  </ul>
</nav> 
       ...
       <tr>
        ...
        <tbody>
       <c:forEach items="${verkoop}" var="verkoop">
        <tr>
            <td>${verkoop.id}</td>
             <td>${verkoop.voornaam}</td>
             <td>${verkoop.achternaam}</td>
             <td>${verkoop.productNaam}</td>
             <td>${verkoop.datum}</td>
          ...
          <input type="submit" value="Verkoop Registreren" class="btn  btn-info" data-toggle="modal" data-target="#verkoopModal"/>
          <div id="verkoopModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Verkoop Registreren </h4>
      </div>
      <div class="modal-body">
        <form method="POST" action="${pageContext.request.contextPath}/InsertVerkoop">
            ...
            <div class="form-group">
                <label>Datum</label>
                <input type="date" name="datum" class="form-control" value="" required/>
            </div>      
            <div class="form-group">
